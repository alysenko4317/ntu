...
public class AccountDAO_JdbcImpl implements AccountDAO
{
    ...
    private NamedParameterJdbcTemplate _templateNP;   // інший варіант для загального ознайомлення
    ...
    private RowMapper<Account> accountRowMapper = (ResultSet rs, int i) ->
    {
        ...
        //      з ними машини; але це не завжди потрібно, тобто часто потрібні дані лише про користувачів, для
        //      цього є другий режим;
        //    при _loadOwnedCars == false дані про машини не будуть отримані з БД, однак буде отримана
        //      інформація про те, чи володіє користувач будь-якими машинами в принципі:

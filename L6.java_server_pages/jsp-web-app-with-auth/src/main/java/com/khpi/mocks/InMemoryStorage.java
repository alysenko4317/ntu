    ...
    // змінна, що зберігає посилання на єдиний екземпляр об'єкта класу FakeStorage
{
    ...
    // приватний, щоб заборонити створення об'єкта поза цим класом, адже клієнти
    // мають використовувати метод getInstance()
    // private to prevent instantiation outside this class - clients
